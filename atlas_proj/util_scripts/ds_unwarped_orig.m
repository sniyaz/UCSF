...
%     dlmwrite('../project_data/static/im2_orig_ds.txt', original_MRI_ds);
    ...
    original_mask = load('../newDataHigRes_Segmentation/Atlas3/Original/MT.mat');
    original_mask = original_mask.Mask;
    original_mask = logical(original_mask);
    original_mask_ds = double(resize(original_mask, sizes));
    
    dlmwrite('../project_data/static/MT_seg3_orig_ds.txt', original_mask_ds);
    ...
    dlmwrite('../project_data/static/MT_consensus_adhoc_3.txt', ad_hoc);
